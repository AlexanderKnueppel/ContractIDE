...
public class LoadAbstractFeature extends AbstractCreateFeature {

	public LoadAbstractFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		FileFilter filter = new FileNameExtensionFilter("Dateien", "model");
