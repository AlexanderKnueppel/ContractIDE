...
public class AddAbstractFeature extends AbstractAddFeature implements IAddFeature {
	...
	public AddAbstractFeature(IFeatureProvider fp) {
		super(fp);
	...
	private static final IColorConstant E_CLASS_FOREGROUND = new ColorConstant(200, 200, 200);

	private static final IColorConstant E_CLASS_BACKGROUND = new ColorConstant(240, 240, 240);
	...
	public PictogramElement add(IAddContext context) {
		Abstract addedClass = (Abstract) context.getNewObject();
