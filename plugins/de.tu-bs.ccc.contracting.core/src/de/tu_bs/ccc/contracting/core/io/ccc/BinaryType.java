...
public class BinaryType {
    ...
    protected List<BinaryType.Component> component;
     ...
     * {@link BinaryType.Component }
     * 
     * 
     */
    public List<BinaryType.Component> getComponent() {
        if (component == null) {
            component = new ArrayList<BinaryType.Component>();
        }
