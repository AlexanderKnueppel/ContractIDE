 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.AssumptionImpl#getContract <em>Contract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssumptionImpl extends ContractPropertyImpl implements Assumption {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return MmPackage.Literals.ASSUMPTION;
	}
	...
	public NotificationChain basicSetContract(Contract newContract, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContract, MmPackage.ASSUMPTION__CONTRACT, msgs);
		return msgs;
	}
	...
	public void setContract(Contract newContract) {
		if (newContract != eInternalContainer()
			...
			if (newContract != null)
				msgs = ((InternalEObject) newContract).eInverseAdd(this, MmPackage.CONTRACT__ASSUMPTION, Contract.class,
						msgs);
			msgs = basicSetContract(newContract, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MmPackage.ASSUMPTION__CONTRACT, newContract,
					newContract));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MmPackage.ASSUMPTION__CONTRACT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case MmPackage.ASSUMPTION__CONTRACT:
			return eInternalContainer().eInverseRemove(this, MmPackage.CONTRACT__ASSUMPTION, Contract.class, msgs);
		}
