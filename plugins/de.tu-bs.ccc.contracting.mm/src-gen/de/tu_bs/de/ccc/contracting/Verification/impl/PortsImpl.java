 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getPortseOpposite <em>Portse Opposite</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getModule <em>Module</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getInsidePorts <em>Inside Ports</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getInsidePortseOpposite <em>Inside Portse Opposite</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getService <em>Service</em>}</li>
 *   <li>{@link de.tu_bs.de.ccc.contracting.Verification.impl.PortsImpl#getOuterDirection <em>Outer Direction</em>}</li>
 * </ul>
 *
 * @generated
 */
